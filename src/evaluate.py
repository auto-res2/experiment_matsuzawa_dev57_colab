...
def experiment1_accuracy_efficiency(model, calib_loader, val_loader, device='cpu', K=4, num_classes=10, weight_bits=4, act_bits=4, out_dir='.research/iteration1/images'):
...
def experiment2_robustness(model, calib_loader, val_loader, device='cpu', K=4, num_classes=10, act_bits=4, out_dir='.research/iteration1/images'):
    modules = find_target_modules(model)
...
def experiment3_ablation(model, calib_loader, val_loader, device='cpu', Ks=(2, 4, 8), fingerprint_bits=(4, 6), num_classes=10, out_dir='.research/iteration1/images'):
    # Weight quantization
    model_q = copy.deepcopy(model)
    quantize_model_weights_inplace(model_q, num_bits=4)
